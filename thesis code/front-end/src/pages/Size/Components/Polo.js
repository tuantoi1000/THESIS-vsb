...
function Polo() {
    ...
    const [measurements, setMeasurements] = useState([
        ...
        { label: t('size.content5'), sizes: [47, 49, 51, 53, 55, 57] },
        { label: t('size.content6'), sizes: [21.5, 22.5, 23, 23.5, 24.5, 25.5] },
        { label: t('size.content8'), sizes: [42.5, 43.5, 44.5, 45.5, 46.5, 47.5] }
